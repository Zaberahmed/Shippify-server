...
import {
     createLabelBasedOnRateId, createShipmentAndGetAllRelevantRates, getServicePointList, updateShipmentById, addSelectedRateForShipment, getAllShipment, cancelShipmentById, updateShipmentStatusId,
...
router.patch('/add-drop-off-pick-up-point/:id', authentication, updateShipmentById);
router.patch('/update-shipment-status/:_id', authentication, updateShipmentStatusId);
